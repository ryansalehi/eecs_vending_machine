...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : enable_motor3_Pin enable_motor4_Pin enable_motor1_Pin enable_motor2_Pin */
  GPIO_InitStruct.Pin = enable_motor3_Pin|enable_motor4_Pin|enable_motor1_Pin|enable_motor2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
